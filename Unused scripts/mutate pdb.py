...
# From: http://salilab.org/modeller/wiki/Mutate%20model
...
#
#     Example: python mutate_model.py 1t29 mutations.txt
#
# with mutations.txt the text file with the mutations e.g.:
# 136 PRO A --> to mutation the residue 136 of chain A to proline
#
#
...
#first argument
modelname, mutationFile = sys.argv[1:]
...
with open(mutationFile) as mfile:
    mutations = mfile.readlines()
